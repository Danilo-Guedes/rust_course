fn main() {
    ...
    let array_of_strings = ["one".to_string(), "two".to_string(), "three".to_string(), "four".to_string(), "five".to_string(),];
...
// BUT WE CAN USER THE .iter() METHOD TO ITERATE OVER THE ARRAY WITHOUT MOVING THE OWNERSHIP how the compiler suggests
    ...
    let array_of_strings_2 = ["one".to_string(), "two".to_string(), "three".to_string(), "four".to_string(), "five".to_string(),];
